...
app.get("/searchResults",(req,res)=>{ 
  // res.send( req.query.search);
   ...
   var url= `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&order=relevance&q=${search}&type=video&key=AIzaSyDQ2f4eccAFwqhcTIfoNVNNwPdFu5_fG1Y`;
